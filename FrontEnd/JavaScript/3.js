var changeColor = () => {
    ...
    //var color = "rgb(" + rangeRed.value + "," + rangeGreen.value + "," + rangeBlue.value + ")"; -- alt satırda ki kod ile aynı
...
var divMouseOver = () => {
    ...
    pickerDiv.classList.add("animate__bounce");
}

var divMouseLeave = () => {
    var pickerDiv = document.getElementById("picker-div");
    pickerDiv.classList.remove("animate__animated");
    pickerDiv.classList.remove("animate__bounce");
}
